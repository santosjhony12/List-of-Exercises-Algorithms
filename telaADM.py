...
def abrir_tela_adm():
    ...
    '''
    labelTime = ctk.CTkLabel(master=frame1, text="Times: ", font=('Roboto', 14)).place(x=44, y=160)
    optionMenuTimes = ctk.CTkOptionMenu(master=janela, values=nomestimes, variable=timeSelecionado, fg_color='gray', width=250)
    optionMenuTimes.place(x=53, y=365)

    labelTime = ctk.CTkLabel(master=frame1, text="Sprint: ", font=('Roboto', 14)).place(x=44, y=220)
    optionMenuSprint = ctk.CTkOptionMenu(master=janela, values=sprints, variable=sprintSelecionada, fg_color='gray', width=250)
    optionMenuSprint.place(x=53, y=425)

    labelTime = ctk.CTkLabel(master=frame1, text="Integrantes: ", font=('Roboto', 14)).place(x=44, y=280)
    optionMenuTimes = ctk.CTkOptionMenu(master=janela, values=integrantes, variable=integranteSelecionado, fg_color='gray', width=250)
    optionMenuTimes.place(x=53, y=485)
